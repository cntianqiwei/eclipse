...
<%!
	public static final String EMP_EDIT_URL = "/eop/pages/back/admin/emp/emp_edit.action" ;
%>
					...
					<form class="form-horizontal" action="<%=EMP_EDIT_URL%>" id="myform" method="post" enctype="multipart/form-data">
						<fieldset>
							...
							<div class="form-group" id="enameDiv">
								...
								<div class="col-md-5">
									<!-- 定义表单输入组件 -->
									<input type="text" id="ename" name="ename" class="form-control" value="${emp.ename}"
							...
							<div class="form-group" id="salaryDiv">
								...
								<div class="col-md-5">
									<!-- 定义表单输入组件 -->
									<input type="text" id="salary" name="salary" class="form-control" value="${emp.salary}"
							...
							<div class="form-group">
								<div class="col-md-5 col-md-offset-3">
									...
									<input type="hidden" id="edid" name="edid" value="${emp.did}">
									<input type="hidden" id="elid" name="elid" value="${emp.lid}">

					...
					<tbody>
						<c:forEach items="${allDepts}" var="dept">
							<tr>
								...
								<td class="text-center"><span id="eid--${dept.eid}" style="cursor:pointer;">${allEmps[dept.eid].ename}</span></td> 
								<td class="text-center"><span class="text-sucess" id="currnum-${dept.did}">${dept.currnum}</span></td>
								<td class="text-center">
									<button id="edit-${dept.did}" class="btn btn-warning" <%=did!=2?"disabled":"" %>>

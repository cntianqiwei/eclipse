...
<%!
	public static final String SUPPLY_DETAILS_URL = "pages/back/admin/supply/supply_details_list.action" ;
%>
		...
		<div class="panel panel-success">
			...
			<div class="panel-body">
				...
				<table class="table table-condensed">
					...
					<tbody>
					<c:forEach items="${allSup}" var="sup">
						<tr>
							<td class="text-center">${sup.title}</td>
							<td class="text-center">${sup.amount}</td>
							<td class="text-center">${sup.money}</td>
							<td class="text-center" id="status">${sup.status}</td>
							<td class="text-center">
								<a type="button" class="btn btn-primary btn-xs" href="<%=SUPPLY_DETAILS_URL%>?spid=${sup.spid}">

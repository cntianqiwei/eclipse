...
<script type="text/javascript"
	src="js/pages/back/admin/supply/supply_goods_add.js"></script>
			...
			<div class="panel panel-success">
				...
				<div class="panel-body">
					<form class="form-horizontal"
						action="<%=SUPPLY_GOODS_ADD_URL%>?spid=${param.spid}" id="myform"
						method="post" enctype="multipart/form-data">
						<fieldset>
								<input type="text" id="spid" name="spid" value="${param.spid}" style="display:none">
							...
							<div class="form-group" id="amountDiv">
								...
								<div class="col-md-5">
									...
									<input type="text" id="amount" name="amount"
										class="form-control" placeholder="请输入商品数量..">
								</div>
								<!-- 定义表单错误提示显示元素 -->
							...
							<div class="form-group" id="noteDiv">
								...
								<div class="col-md-5">
									...
									<textarea id="note" name="note" class="form-control"
										placeholder="请输入商品相关说明" rows="10"></textarea>
								</div>
								<!-- 定义表单错误提示显示元素 -->

...
<%!
	public static final String SUPPLY_EMP_APPLY_HANDLE = "pages/back/admin/supply/supply_emp_apply_handle.action" ;
%>
		...
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<table class="table table-condensed">
					...
					<tbody>
					<c:forEach items="${allEmpResource}" var="EmpResource" >
						<tr>
							<td class="text-center">${EmpResource.title}</td>
							<td class="text-center"><span id="eid+${EmpResource.eid}" style="cursor:pointer;">${EmpResource.eid}</span></td>
							<td class="text-center">${EmpResource.subdate}</td>
							<td class="text-center">${EmpResource.amount}</td>
							<td class="text-center">${EmpResource.money}</td>
							<td class="text-center" id="status">${EmpResource.status}</td>
							<td class="text-center">
								<a type="button" class="btn btn-primary btn-xs" href="<%=SUPPLY_EMP_APPLY_HANDLE%>?eresid=${EmpResource.eresid}">

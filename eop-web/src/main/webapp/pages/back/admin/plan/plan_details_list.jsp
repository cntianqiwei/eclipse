			...
			<div class="panel-body">
				<div class="row">
					<table class="table table-condensed table-striped table-hover">
						<tr>
							<td style="width:15%;"><strong>任务编号：</strong></td>
							<td id="pid">${plan.pid }</td>
						</tr>
						...
						<tr>
							<td style="width:15%;"><strong>发布人：</strong></td>
							<td>${plan.eid }</td>
						</tr>
							...
							<div class="panel-heading">
								<h4 class="panel-title"> 
									<a data-toggle="collapse" data-parent="news" href="#contentOne">
										<strong><span class="glyphicon glyphicon-user"></span>&nbsp;任务参与人员清单（当前人数：<span id="currentAmount">${plan.amount }</span>人）</strong>
									</a>
								</h4>
							</div>
									...
									<table class="table table-condensed">
										...
										<tbody>
											...
											<c:forEach items="${allEmps}" var="emp">
												...
												<td class="text-center"><span id="${emp.ename}" style="cursor:pointer;">${emp.ename}</span></td>
												<td class="text-center">${allLevels[emp.lid] }</td>
												<td class="text-center">${allDepts[emp.did] }</td>
												<td class="text-center">${emp.phone}</td>
												<td class="text-center">
													<button type="button" class="btn btn-primary btn-xs" id="remove-${emp.eid}">
